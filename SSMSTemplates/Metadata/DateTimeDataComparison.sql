...
SELECT
  ...
  , [sq].[TABLE_SCHEMA] AS [SQL_TABLE_SCHEMA]
...
CREATE UNIQUE CLUSTERED INDEX [CCI] ON [DateTimeDataComparison]( [TABLE_NAME], [SQL_TABLE_SCHEMA], [SF_TABLE_SCHEMA], [COLUMN_NAME], [COLUMN_VALUE] ) ;
...
CREATE UNIQUE CLUSTERED INDEX [CCI] ON [DateDataComparison]( [TABLE_NAME], [SQL_TABLE_SCHEMA], [SF_TABLE_SCHEMA], [COLUMN_NAME], [COLUMN_VALUE] ) ;
